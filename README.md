# Asia Pacific University of Technology and Innovation Trademark Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The Asia Pacific University of Technology and Innovation Trademarks Logo. They
do not supply their trademark logo but we are in dire need to reference the
studio and its brand for official documentations in research papers. Hence, the
only choice is to re-draw it. The prefered version is `.svg` which has
non-destructive scale up & down properties and can be converted into any
rasterized images (e.g. `jpeg`, `webp`, `avif`, etc).

This project re-draws Asia Pacific University of Technology and Innovation
Trademark Logo Trademarks Logo specifically for 1200x630 size.
...
Asia Pacific University of Technology and Innovation Trademark Logo does not
supply any trademark logo guideline. Hence, it is only assume the logo **MUST**
be exactly the same as its rasterized version "as it is".

While not specified by Asia Pacific University of Technology and Innovation,
please ensure the output are also web ready. Refer:
...
```
--------------------------------------------------------------------------------
Title: Asia Pacific University of Technology and Innovation Trademark Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-apu-1200x630
UUID: 4CDFDD17-0014-41E4-B665-7B48E64922DA
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2025-01-06
Made From: Malaysia, South East Asia
Procure: https://github.com/ChewKeanHo/visuals-trademarks-apu-1200x630
--------------------------------------------------------------------------------
```
...
> **YOU ARE STILL OBLIGATED TO COMPLY WITH ASIA PACIFIC UNIVERSITY OF TECHNOLOGY
> AND INNOVATION TRADEMARK REQUIREMENTS**.
>
